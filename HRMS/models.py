...
class Clientmst(models.Model):
    ...
    cname = models.CharField(db_column='CName', max_length=100, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    ccode = models.CharField(db_column='CCode', max_length=10, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    
    district = models.CharField(db_column='District', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    
    csname = models.CharField(db_column='CSName', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    address = models.CharField(db_column='Address', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    state = models.CharField(db_column='State', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    pin = models.CharField(db_column='Pin', max_length=10, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    oficeph = models.CharField(db_column='OficePh', max_length=15, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    email = models.CharField(db_column='Email', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    contractno = models.CharField(db_column='ContractNo', max_length=20, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    ...
    gstno = models.CharField(db_column='GSTNo', max_length=30, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    contractvalue = models.FloatField(db_column='ContractValue', blank=True, null=True)  
    bonus = models.CharField(db_column='Bonus', max_length=5, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    epf = models.CharField(db_column='EPF', max_length=5, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    esi = models.CharField(db_column='ESI', max_length=5, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    
    contactperson = models.CharField(db_column='ContactPerson', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    contactmobileno = models.CharField(db_column='ContactMobileNo', max_length=15, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    contactemail = models.CharField(db_column='ContactEmail', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    contactdesg = models.CharField(db_column='ContactDesg', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    
    userid = models.CharField(db_column='Userid', max_length=30, db_collation="utf8mb4_general_ci", blank=True, null=True) 
    cdate = models.DateTimeField(auto_now_add=True, db_column='Cdate', blank=True, null=True)
    modifyuser = models.CharField(db_column='ModifyUser', max_length=30, db_collation="utf8mb4_general_ci", blank=True, null=True) 
...
class Divisionmst(models.Model):
    ...
    division = models.CharField(db_column='Division', max_length=100, blank=True, null=True, db_collation="utf8mb4_general_ci")
    bankname = models.CharField(db_column='BankName', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    ifsccode = models.CharField(db_column='IFSCCode', max_length=20, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    bankaccno = models.BigIntegerField(db_column='BankAccNO', blank=True, null=True)  
      
    userid = models.CharField(db_column='Userid', max_length=20, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    cdate = models.DateTimeField(auto_now_add=True, db_column='Cdate', blank=True, null=True)
    
    modifyuser = models.CharField(db_column='ModifyUser', max_length=20, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    mdate = models.DateTimeField(auto_now=True, db_column='MDate', blank=True, null=True)  
...
class Clientdivisionestimatebilling(models.Model):
    ...
    gston = models.CharField(db_column='GSTON', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    
    
    cdate = models.DateTimeField(auto_now_add=True, db_column='Cdate', blank=True, null=True)
    mdate = models.DateTimeField(auto_now=True, db_column='MDate', blank=True, null=True)
 
    muserid = models.CharField(db_column='MUserId', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    cuserid = models.CharField(db_column='CUserId', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
...
class Clientdivisionestimatebillingdtl(models.Model):
    ...
    category = models.CharField(db_column='Category', max_length=30, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    strength = models.IntegerField(db_column='Strength', blank=True, null=True)  
    ...
    cuserid = models.CharField(db_column='CUserId', max_length=20, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    cdate = models.DateTimeField(auto_now_add=True, db_column='Cdate', blank=True, null=True)
    muserid = models.CharField(db_column='MUserId', max_length=20, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    mdate = models.DateTimeField(auto_now=True, db_column='MDate', blank=True, null=True)  
...
class Employeemst(models.Model):
    ...
    empcode = models.CharField(db_column='EmpCode', max_length=10, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    empname = models.CharField(db_column='EmpName', max_length=100, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    empfhname = models.CharField(db_column='EmpFHName', max_length=100, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    empdob = models.DateTimeField(db_column='EmpDob', blank=True, null=True)  
    qualification = models.CharField(db_column='Qualification', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    mobileno = models.CharField(db_column='MobileNo', max_length=30, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    emergencyno = models.CharField(db_column='EmergencyNo', max_length=15, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    bloodgroup = models.CharField(db_column='BloodGroup', max_length=5, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    gender = models.CharField(db_column='Gender', max_length=15, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    joinningdate = models.DateTimeField(db_column='JoinningDate', blank=True, null=True)  
    department = models.CharField(db_column='Department', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    desgination = models.CharField(db_column='Desgination', max_length=100, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    cid = models.ForeignKey(Clientmst, on_delete=models.CASCADE, db_column='CId', blank=True, null=True) 
    did = models.ForeignKey(Divisionmst, on_delete=models.CASCADE, db_column='Did', blank=True, null=True) 
    preaddress = models.CharField(db_column='PreAddress', max_length=150, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    precity = models.CharField(db_column='PreCity', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    predist = models.CharField(db_column='PreDist', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    prestate = models.CharField(db_column='PreState', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    prepin = models.CharField(db_column='PrePin', max_length=10, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    peraddress = models.CharField(db_column='PerAddress', max_length=150, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    percity = models.CharField(db_column='PerCity', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    perdist = models.CharField(db_column='PerDist', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    perstate = models.CharField(db_column='PerState', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    perpin = models.CharField(db_column='PerPin', max_length=10, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    unno = models.CharField(db_column='UNNo', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    aadharno = models.CharField(db_column='AadharNo', max_length=20, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    bankname = models.CharField(db_column='BankName', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    accountno = models.CharField(db_column='AccountNo', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    ifsccode = models.CharField(db_column='IFSCCode', max_length=25, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    ...
    epfno = models.CharField(db_column='EPFNo', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    esino = models.CharField(db_column='ESINo', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    ...
    bonus = models.CharField(db_column='Bonus', max_length=2, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    leave = models.CharField(max_length=2, blank=True, null=True, db_collation="utf8mb4_general_ci")
    epf = models.CharField(db_column='EPF', max_length=2, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    esi = models.CharField(db_column='ESI', max_length=2, blank=True, null=True, db_collation="utf8mb4_general_ci")  
...
class Emploanhdr(models.Model):
    ...
    empcode = models.CharField(db_column='EmpCode', max_length=20, db_collation='utf8mb4_general_ci', blank=True, null=True) 
    ...
    startyearmonth = models.CharField(db_column='StartYearMonth', max_length=20, db_collation='utf8mb4_general_ci', blank=True, null=True) 
    
    paidinst = models.IntegerField(db_column='PaidInst', blank=True, null=True) 
    appfilepath = models.CharField(db_column='AppFilePath', max_length=100, db_collation='utf8mb4_general_ci', blank=True, null=True)
    
    cuserid = models.CharField(db_column='CUserId', max_length=20, db_collation='utf8mb4_general_ci', blank=True, null=True) 
...
class Emploandtl(models.Model):
    ...
    empid = models.ForeignKey(Employeemst , on_delete=models.CASCADE , db_column='EmpId', blank=True, null=True)
    yearmonth = models.CharField(db_column='YearMonth', max_length=20, db_collation='utf8mb4_general_ci', blank=True, null=True) 
...
class Employeesalaryupdate(models.Model):
    ...
    cuserid = models.CharField(db_column='CUserId', max_length=15, db_collation='utf8mb4_general_ci', blank=True, null=True) 
    cdate = models.DateTimeField(db_column='CDate', auto_now_add=True, blank=True, null=True) 
    auserid = models.CharField(db_column='AUserId', max_length=15, db_collation='utf8mb4_general_ci', blank=True, null=True) 
...
class Empattendancehdr(models.Model):
    ...
    atnno = models.CharField(db_column='AtnNo', max_length=20, db_collation='utf8mb4_general_ci', blank=True, null=True) 
    
    cid = models.ForeignKey(Clientmst, on_delete=models.CASCADE, db_column='CId', blank=True, null=True) 
    did = models.ForeignKey(Divisionmst, on_delete=models.CASCADE, db_column='Did', blank=True, null=True) 
    
    
    atnyearmonth = models.CharField(db_column='AtnYearMonth', max_length=10, db_collation='utf8mb4_general_ci', blank=True, null=True) 
    ...
    guserid = models.CharField(db_column='GUserId', max_length=20, db_collation='utf8mb4_general_ci', blank=True, null=True) 
    ...
    submituserid = models.CharField(db_column='SubmitUserId', max_length=20, db_collation='utf8mb4_general_ci', blank=True, null=True) 
    
    submitdt = models.DateTimeField(db_column='SubmitDt', auto_now_add=True, blank=True, null=True) 
    auserid = models.CharField(db_column='AUserId', max_length=20, db_collation='utf8mb4_general_ci', blank=True, null=True) 
    ...
    ruserid = models.CharField(db_column='RUserId', max_length=20, db_collation='utf8mb4_general_ci', blank=True, null=True) 
...
class Empattendancedtl(models.Model):
    ...
    yearmonth = models.CharField(db_column='YearMonth', max_length=10, db_collation='utf8mb4_general_ci', blank=True, null=True)  
...
class Empsalaryhdr(models.Model):
    ...
    salaryno = models.CharField(db_column='SalaryNo', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    ...
    attnyearmonth = models.CharField(db_column='AttnYearMonth', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    ...
    gdate = models.DateTimeField(db_column='GDate', auto_now_add=True,  blank=True, null=True)  
    guserid = models.CharField(db_column='GUserId', max_length=20, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    ...
    submituserid = models.CharField(db_column='SubmitUserid', max_length=20, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    
    approvstatus = models.IntegerField(db_column='ApprovStatus', blank=True, null=True)  
    approvuserid = models.CharField(db_column='ApprovUserid', max_length=20, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    approvdate = models.DateTimeField(db_column='ApprovDate', blank=True, null=True)  
    ...
    payuserid = models.CharField(db_column='PayUserId', max_length=20, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    
    submitpaysts = models.IntegerField(db_column='SubmitPaySts', blank=True, null=True)  
    submitpayuserid = models.CharField(db_column='SubmitPayUserId', max_length=20, blank=True, null=True, db_collation="utf8mb4_general_ci")  
...
class Empsalarydtl(models.Model):
    ...
    yearmonth = models.CharField(db_column='YearMonth', max_length=10, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    ...
    processuserid = models.CharField(db_column='ProcessUserId', max_length=20, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    ...
    releaseuserid = models.CharField(db_column='ReleaseUserid', max_length=20, blank=True, null=True, db_collation="utf8mb4_general_ci")  
...
class Empepfhdr(models.Model):
    ...
    yearmonth = models.CharField(db_column='YearMonth', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    ...
    batchno = models.CharField(db_column='BatchNo', max_length=10, blank=True, null=True, db_collation="utf8mb4_general_ci")  
...
class Empepfdtl(models.Model):
    ...
    status = models.IntegerField(db_column='Status', blank=True, null=True)  
    remark = models.CharField(db_column='Remark', max_length=200, blank=True, null=True, db_collation="utf8mb4_general_ci")  
...
class Billhdr(models.Model):
    ...
    billreffno = models.CharField(db_column='BillReffNo', max_length=20, blank=True, null=True, db_collation="utf8mb4_general_ci")
    billno = models.CharField(db_column='BillNo', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")   
    orderno = models.CharField(db_column='OrderNo', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    
    billdate = models.DateTimeField(db_column='BillDate', blank=True, null=True) 

    address1 = models.CharField(db_column='Address1', max_length=500, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    address2 = models.CharField(db_column='Address2', max_length=500, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    ...
    othersname = models.CharField(db_column='OthersName', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    others = models.FloatField(db_column='Others', blank=True, null=True)  
    ...
    appuserid = models.CharField(db_column='AppUserId', max_length=20, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    cuserid = models.CharField(db_column='CUserId', max_length=20, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    cdate = models.DateTimeField(auto_now_add=True, db_column='Cdate', blank=True, null=True)
    muserid = models.CharField(db_column='MUserId', max_length=20, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    mdate = models.DateTimeField(auto_now=True, db_column='MDate', blank=True, null=True)  
    city = models.CharField(db_column='City', max_length=200, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    contactperson = models.CharField(db_column='ContactPerson', max_length=100, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    phone = models.CharField(db_column='Phone', max_length=30, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    fax = models.CharField(db_column='Fax', max_length=30, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    email = models.CharField(db_column='EMail', max_length=100, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    pan = models.CharField(db_column='PAN', max_length=20, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    gstin = models.CharField(db_column='GSTIN', max_length=30, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    provcontactperson = models.CharField(db_column='ProvContactPerson', max_length=100, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    provphone = models.CharField(db_column='ProvPhone', max_length=30, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    attndate = models.CharField(db_column='AttnDate', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
...
class Billdtl(models.Model):
    ...
    category = models.CharField(db_column='Category', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    ...
    userid = models.CharField(db_column='UserId', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    cdate = models.DateTimeField(auto_now_add=True, db_column='Cdate', blank=True, null=True)
    muserid = models.CharField(db_column='MUserId', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    mdate = models.DateTimeField(auto_now=True, db_column='MDate', blank=True, null=True)  
...
class Clientcontactdetails(models.Model):
    ...
    cid = models.ForeignKey(Clientmst, on_delete=models.CASCADE, db_column='Cid', blank=True, null=True)
    cguid = models.CharField(db_column='CGuid', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    contactperson = models.CharField(db_column='ContactPerson', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    contactmobileno = models.CharField(db_column='ContactMobileNo', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    contactemail = models.CharField(db_column='ContactEmail', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    contactdesg = models.CharField(db_column='ContactDesg', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    remark = models.CharField(db_column='Remark', max_length=500, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    cuserid = models.CharField(db_column='CUserId', max_length=20, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    cdate = models.DateTimeField(auto_now_add=True, db_column='Cdate', blank=True, null=True)
    muserid = models.CharField(db_column='MUserId', max_length=20, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    mdate = models.DateTimeField(auto_now=True, db_column='MDate', blank=True, null=True)  
...
class Companydocuments(models.Model):
    ...
    docname = models.CharField(db_column='DocName', max_length=500, db_collation='utf8mb4_general_ci', blank=True, null=True) 
    docregdt = models.CharField(db_column='DocRegDt', max_length=50, db_collation='utf8mb4_general_ci', blank=True, null=True) 
    docexpirdt = models.CharField(db_column='DocExpirDt', max_length=50, db_collation='utf8mb4_general_ci', blank=True, null=True) 
    
    unsignpath = models.CharField(db_column='UnSignPath', max_length=500, db_collation='utf8mb4_general_ci', blank=True, null=True) 
    signpath = models.CharField(db_column='SignPath', max_length=500, db_collation='utf8mb4_general_ci', blank=True, null=True) 
...
class Tenders(models.Model):
    ...
    tendername = models.CharField(db_column='TenderName', blank=True, null=True , max_length=200, db_collation="utf8mb4_general_ci")  
    ...
    category = models.CharField(db_column='Category', max_length=20, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    strength = models.IntegerField(db_column='Strength', blank=True, null=True)  
    contractvalue = models.FloatField(db_column='ContractValue', blank=True, null=True)  
    contractperiod = models.CharField(db_column='ContractPeriod', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    websitename = models.CharField(db_column='WebSiteName', max_length=100, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    ...
    modesubmision = models.CharField(db_column='ModeSubmision', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    ...
    emd = models.CharField(db_column='EMD', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    
    prepareuserid = models.CharField(db_column='PrepareUserId', max_length=20, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    moniteruserid = models.CharField(db_column='MoniterUserId', max_length=20, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    ...
    submituserid = models.CharField(db_column='SubmitUserId', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    submitdt = models.DateTimeField(db_column='SubmitDt', blank=True, null=True) 
    
    advdocpath = models.CharField(db_column='AdvDocPath', max_length=200, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    status = models.IntegerField(db_column='Status', blank=True, null=True)  
...
class Tenderstatusdoc(models.Model):
    ...
    statusremark = models.CharField(db_column='StatusRemark', blank=True, null=True , max_length=20, db_collation="utf8mb4_general_ci")  
    docpath = models.CharField(db_column='DocPath', max_length=500, blank=True, null=True, db_collation="utf8mb4_general_ci")  
...
class Tenderfinbiddoc(models.Model):
    ...
    finbidremark = models.CharField(db_column='FinBidRemark', blank=True, null=True , max_length=20, db_collation="utf8mb4_general_ci")  
    docpath = models.CharField(db_column='DocPath', max_length=500, blank=True, null=True, db_collation="utf8mb4_general_ci")  
...
class Tenderdocument(models.Model):
    ...
    tenderdocname = models.CharField(db_column='TenderDocName', max_length=500, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    docpath = models.CharField(db_column='DocPath', max_length=500, blank=True, null=True, db_collation="utf8mb4_general_ci")  
...
class Autotradehdr(models.Model):
    ...
    tradecode = models.CharField(db_column='TradeCode', max_length=30, blank=True, null=True, db_collation="utf8mb4_general_ci")  
...
class Autotradermbrdtl(models.Model):
    id = models.AutoField(db_column='Id', primary_key=True)
    trdid = models.IntegerField(db_column='TrdId', blank=True, null=True)  
    mbrid = models.CharField(db_column='MbrId', max_length=20, blank=True, null=True, db_collation="utf8mb4_general_ci"  )  
...
class Autotradewallet(models.Model):
    id = models.AutoField(db_column='Id', primary_key=True)
    mbrid = models.CharField(db_column='MbrId', max_length=15, blank=True, null=True, db_collation="utf8mb4_general_ci"  )  
    tid = models.IntegerField(db_column='Tid', blank=True, null=True)  
    amount = models.FloatField(db_column='Amount', blank=True, null=True)  
    ttype = models.CharField(db_column='Ttype', max_length=5, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    dt = models.DateTimeField(db_column='Dt', blank=True, null=True)  
...
class Branch(models.Model):
    ...
    branch = models.CharField(db_column='Branch', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
...
class Clientbillmst(models.Model):
    bid = models.IntegerField(db_column='BId', blank=True, null=True)  
    did = models.IntegerField(db_column='Did', blank=True, null=True)  
    monthyear = models.CharField(db_column='MonthYear', max_length=15, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    billno = models.CharField(db_column='BillNo', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    billdate = models.DateTimeField(db_column='BillDate', blank=True, null=True)  
    strength = models.IntegerField(db_column='Strength', blank=True, null=True)  
    ...
    total = models.FloatField(db_column='Total', blank=True, null=True)  
    gst = models.FloatField(db_column='GST', blank=True, null=True)  
    filepath = models.CharField(db_column='FilePath', max_length=500, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    remark = models.CharField(db_column='Remark', max_length=500, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    cuserid = models.CharField(db_column='CUserId', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    cdate = models.DateTimeField(auto_now_add=True, db_column='Cdate', blank=True, null=True)
    muserid = models.CharField(db_column='MUserId', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
...
class Clientbillreceive(models.Model):
    ...
    did = models.ForeignKey(Divisionmst, on_delete=models.CASCADE, db_column='Did', blank=True, null=True)  
    recptno = models.CharField(db_column='RecptNo', max_length=25, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    ...
    bank = models.CharField(db_column='Bank', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    chequeno = models.CharField(db_column='ChequeNo', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
...
class Companybank(models.Model):
    ...
    bankname = models.CharField(db_column='BankName', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    accno = models.CharField(db_column='AccNo', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    ifsc = models.CharField(db_column='IFSC', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
...
class DelEmployeemst20230127(models.Model):
    ...
    epfno = models.CharField(db_column='EPFNo', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    esino = models.CharField(db_column='ESINo', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    wagestype = models.CharField(db_column='WagesType', max_length=2, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    billtype = models.CharField(db_column='Billtype', max_length=2, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    bonus = models.CharField(db_column='Bonus', max_length=2, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    leave = models.CharField(max_length=2, blank=True, null=True, db_collation="utf8mb4_general_ci")
    epf = models.CharField(db_column='EPF', max_length=2, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    esi = models.CharField(db_column='ESI', max_length=2, blank=True, null=True, db_collation="utf8mb4_general_ci")  
...
class DjangoMigrations(models.Model):
    ...
    app = models.CharField(max_length=255, db_collation="utf8mb4_general_ci")
...
class Emp9(models.Model):
    ...
    emplyee_code = models.CharField(db_column='Emplyee Code', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")   
    emplyee_name = models.CharField(db_column='Emplyee Name', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")   
    father_husband_name = models.CharField(db_column='Father/Husband Name', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")   
    client_code = models.CharField(db_column='Client Code', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")   
    client_name = models.CharField(db_column='Client Name', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")   
    division = models.CharField(db_column='Division', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    designation = models.CharField(db_column='Designation', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    department = models.CharField(db_column='Department', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    date_of_birth = models.DateTimeField(db_column='Date of birth', blank=True, null=True)   
    qualification = models.CharField(db_column='Qualification', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    mobile_no_field = models.CharField(db_column='Mobile No#', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")
    emergency_no = models.CharField(db_column='Emergency No', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")   
    blood_group = models.CharField(db_column='Blood Group', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")   
    date_of_joinning = models.DateTimeField(db_column='Date of Joinning', blank=True, null=True)   
    gender = models.CharField(db_column='Gender', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    present_address = models.CharField(db_column='Present Address', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")   
    city = models.CharField(db_column='City', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    distirct = models.CharField(db_column='Distirct', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    state = models.CharField(db_column='State', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    pin_code = models.CharField(db_column='Pin Code', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")   
    aadhar_no_field = models.CharField(db_column='Aadhar No#', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")
    un_no_field = models.FloatField(db_column='UN No#', blank=True, null=True)
    epf_no_field = models.CharField(db_column='EPF No#', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")
    esi_no_field = models.CharField(db_column='ESI No#', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")
    a_c_number = models.CharField(db_column='A/c Number', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")   
    ifsc_code = models.CharField(db_column='IFSC Code', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")   
    bank_name = models.CharField(db_column='Bank Name', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")   
    wages_type = models.CharField(db_column='Wages Type', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")   
    basic_wages = models.CharField(db_column='Basic Wages', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")   
    epf = models.CharField(db_column='EPF', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    esi = models.CharField(db_column='ESI', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    status = models.CharField(db_column='Status', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
...
class Emp1(models.Model):
    ...
    designation = models.CharField(db_column='DESIGNATION', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    department = models.CharField(db_column='DEPARTMENT', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    date_of_birth = models.CharField(db_column='DATE OF BIRTH', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")   
    qualification = models.CharField(db_column='QUALIFICATION', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    mobile_no_field = models.CharField(db_column='MOBILE NO#', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")
    ...
    date_of_joinning = models.CharField(db_column='DATE OF JOINNING', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")   
    gender = models.CharField(db_column='GENDER', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    present_address = models.CharField(db_column='PRESENT ADDRESS', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")   
    city = models.CharField(db_column='CITY', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    distirct = models.CharField(db_column='DISTIRCT', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    ...
    esi = models.CharField(db_column='ESI', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    status = models.CharField(db_column='STATUS', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    status1 = models.CharField(db_column='STATUS1', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
...
class Emp10Delete(models.Model):
    sl_no_field = models.FloatField(db_column='Sl# No#', blank=True, null=True)
    emplyeecode = models.CharField(db_column='EmplyeeCode', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    emplyee_name = models.CharField(db_column='Emplyee Name', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")   
    father_husband_name = models.CharField(db_column='Father/Husband Name', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")   
    client_code = models.CharField(db_column='Client Code', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")   
    client_name = models.CharField(db_column='Client Name', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")   
    ...
    pin_code = models.CharField(db_column='Pin Code', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")   
    aadhar_no_field = models.CharField(db_column='Aadhar No#', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")
    un_no_field = models.CharField(db_column='UN No#', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")
    epf_no_field = models.CharField(db_column='EPF No#', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")
    esi_no_field = models.CharField(db_column='ESI No#', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")
    a_c_number = models.CharField(db_column='A/c Number', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")   
    ifsc_code = models.CharField(db_column='IFSC Code', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")   
...
class Emp3(models.Model):
    ...
    esi = models.CharField(db_column='ESI', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    status = models.CharField(db_column='Status', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    f33 = models.CharField(db_column='F33', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
...
class Emp4(models.Model):
    ...
    esi = models.CharField(db_column='ESI', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    status = models.CharField(db_column='Status', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    f34 = models.CharField(db_column='F34', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    f35 = models.CharField(db_column='F35', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    f36 = models.CharField(db_column='F36', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    f37 = models.CharField(db_column='F37', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    f38 = models.CharField(db_column='F38', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    f39 = models.CharField(db_column='F39', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    f40 = models.CharField(db_column='F40', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    f41 = models.CharField(db_column='F41', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    f42 = models.CharField(db_column='F42', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    f43 = models.CharField(db_column='F43', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    f44 = models.CharField(db_column='F44', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    f45 = models.CharField(db_column='F45', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    f46 = models.CharField(db_column='F46', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    f47 = models.CharField(db_column='F47', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    f48 = models.CharField(db_column='F48', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    f49 = models.CharField(db_column='F49', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    f50 = models.CharField(db_column='F50', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    f51 = models.CharField(db_column='F51', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    f52 = models.CharField(db_column='F52', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    f53 = models.CharField(db_column='F53', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    f54 = models.CharField(db_column='F54', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    f55 = models.CharField(db_column='F55', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    f56 = models.CharField(db_column='F56', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    f57 = models.CharField(db_column='F57', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    f58 = models.CharField(db_column='F58', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    f59 = models.CharField(db_column='F59', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    f60 = models.CharField(db_column='F60', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    f61 = models.CharField(db_column='F61', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    f62 = models.CharField(db_column='F62', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
...
class Emp5(models.Model):
    ...
    emergency_no = models.DateTimeField(db_column='Emergency No', blank=True, null=True)   
    blood_group = models.FloatField(db_column='Blood Group', blank=True, null=True)   
    doj = models.CharField(db_column='DOJ', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    gender = models.CharField(db_column='Gender', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    present_address = models.CharField(db_column='Present Address', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")   
    city = models.CharField(db_column='City', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    distirct = models.CharField(db_column='Distirct', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    ...
    esi = models.CharField(db_column='ESI', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    status = models.CharField(db_column='Status', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    jhggf = models.CharField(max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")
...
class EmpNew(models.Model):
    ...
    name = models.CharField(db_column='NAME', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    fname = models.CharField(db_column='FNAME', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    clientcode = models.CharField(db_column='ClientCode', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    clientname = models.CharField(db_column='ClientName', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    division = models.CharField(db_column='Division', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    designation = models.CharField(db_column='Designation', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    department = models.CharField(db_column='Department', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    dob = models.DateTimeField(db_column='DOB', blank=True, null=True)  
    doj = models.DateTimeField(db_column='DOJ', blank=True, null=True)  
    paddress = models.CharField(db_column='PAddress', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    ...
    esic = models.CharField(db_column='ESIC', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    bankname = models.CharField(db_column='BANKNAME', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    accountno = models.CharField(db_column='ACCOUNTNO', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    ifsccode = models.CharField(db_column='IFSCCODE', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    basicwages = models.FloatField(db_column='BasicWages', blank=True, null=True)  
    cid = models.IntegerField(db_column='CID', blank=True, null=True)  
    did = models.IntegerField(db_column='DId', blank=True, null=True)  
    empcode = models.CharField(db_column='EmpCode', max_length=20, blank=True, null=True, db_collation="utf8mb4_general_ci")  
...
class EmpNew1(models.Model):
    ...
    doj = models.DateTimeField(db_column='DOJ', blank=True, null=True)  
    paddress = models.CharField(db_column='Paddress', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    aadharno = models.CharField(db_column='AadharNo', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    unno = models.FloatField(db_column='UNNo', blank=True, null=True)  
...
class Emparrearsalarydtl(models.Model):
    ...
    processstatus = models.IntegerField(db_column='ProcessStatus', blank=True, null=True)  
    processdt = models.DateTimeField(db_column='ProcessDt', blank=True, null=True)  
    processuserid = models.CharField(db_column='ProcessUserId', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    releasests = models.IntegerField(db_column='ReleaseSts', blank=True, null=True)  
    releasedt = models.DateTimeField(db_column='ReleaseDt', blank=True, null=True)  
    releaseuserid = models.CharField(db_column='ReleaseUserid', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    paystatus = models.IntegerField(db_column='PayStatus', blank=True, null=True)  
    paydt = models.DateTimeField(db_column='PayDt', blank=True, null=True)  
    payuserid = models.CharField(db_column='PayUserid', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
...
class Emparrearsalaryhdr(models.Model):
    asid = models.IntegerField(db_column='ASId', blank=True, null=True)  
    asalaryno = models.CharField(db_column='ASalaryNo', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    cid = models.IntegerField(db_column='CId', blank=True, null=True)  
    did = models.IntegerField(db_column='DId', blank=True, null=True)  
    yearmonth = models.CharField(db_column='YearMonth', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
...
class Empepfarrearhdr(models.Model):
    aepfid = models.IntegerField(db_column='AEpfId', blank=True, null=True)  
    aepfno = models.CharField(db_column='AEpfNo', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    cid = models.IntegerField(db_column='CId', blank=True, null=True)  
    did = models.IntegerField(db_column='DId', blank=True, null=True)  
    yearmonth = models.CharField(db_column='YearMonth', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    totalepf = models.FloatField(db_column='TotalEPF', blank=True, null=True)  
...
class Empepfdepositebatch(models.Model):
    id = models.AutoField(db_column='Id', primary_key=True)
    epfbatchno = models.CharField(db_column='EpfBatchNo', max_length=10, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    epfids = models.CharField(db_column='EpfIds', blank=True, null=True , max_length=20, db_collation="utf8mb4_general_ci")  
    yearmonth = models.CharField(db_column='YearMonth', max_length=10, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    batchdate = models.DateTimeField(db_column='BatchDate', blank=True, null=True)  
    cuserid = models.CharField(db_column='CUserId', max_length=10, blank=True, null=True, db_collation="utf8mb4_general_ci")  
...
class Empesidepositebatch(models.Model):
    id = models.AutoField(db_column='Id', primary_key=True)
    esibatchno = models.CharField(db_column='EsiBatchNo', max_length=10, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    esiids = models.CharField(db_column='EsiIds', blank=True, null=True , max_length=20, db_collation="utf8mb4_general_ci")  
    yearmonth = models.CharField(db_column='YearMonth', max_length=10, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    batchdate = models.DateTimeField(db_column='BatchDate', blank=True, null=True)  
    cuserid = models.CharField(db_column='CUserId', max_length=10, blank=True, null=True, db_collation="utf8mb4_general_ci")  
...
class Employeemst0608(models.Model):
    ...
    perstate = models.CharField(db_column='PerState', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    perpin = models.CharField(db_column='PerPin', max_length=10, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    unno = models.CharField(db_column='UNNo', max_length=20, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    aadharno = models.CharField(db_column='AadharNo', max_length=20, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    bankname = models.CharField(db_column='BankName', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    accountno = models.CharField(db_column='AccountNo', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    ifsccode = models.CharField(db_column='IFSCCode', max_length=25, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    ...
    medical = models.FloatField(db_column='Medical', blank=True, null=True)  
    resallow = models.FloatField(db_column='ResAllow', blank=True, null=True)  
    epfno = models.CharField(db_column='EPFNo', max_length=20, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    esino = models.CharField(db_column='ESINo', max_length=20, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    wagestype = models.CharField(db_column='WagesType', max_length=2, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    billtype = models.CharField(db_column='Billtype', max_length=2, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    bonus = models.CharField(db_column='Bonus', max_length=2, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    leave = models.CharField(max_length=2, blank=True, null=True, db_collation="utf8mb4_general_ci")
...
class Employeeslks(models.Model):
    ...
    sl_no_field = models.FloatField(db_column='SL NO#', blank=True, null=True)
    empcode = models.CharField(db_column='EmpCode', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    employee_name = models.CharField(db_column='Employee Name', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")   
    father_s_name = models.CharField(db_column="Father's Name", max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")   
    designation = models.CharField(db_column='Designation', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    gender = models.CharField(db_column='GENDER', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    dob = models.DateTimeField(db_column='DOB', blank=True, null=True)  
    doj = models.DateTimeField(db_column='DOJ', blank=True, null=True)  
    qualification = models.CharField(db_column='Qualification', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    mob_no = models.CharField(db_column='Mob No', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")   
    uan_no = models.CharField(db_column='UAN NO', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")   
    esic_no = models.CharField(db_column='ESIC NO', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")   
    aadhar_no = models.CharField(db_column='AADHAR NO', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")   
    permanent_present_address = models.CharField(db_column='Permanent/Present Address', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")   
    bank_name = models.CharField(db_column='Bank Name', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")   
    bank_a_c_no = models.CharField(db_column='Bank A/c No', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")   
    ifsc_code = models.CharField(db_column='IFSC Code', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")   
    dept = models.CharField(db_column='Dept', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    divison = models.CharField(db_column='Divison', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    client_site_location = models.CharField(db_column='Client/Site_location', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")   
    client_code = models.CharField(db_column='Client Code', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")   
    district = models.CharField(db_column='DISTRICT', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    wages = models.FloatField(db_column='Wages', blank=True, null=True)  
    remarks = models.CharField(db_column='Remarks', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    relationship_manager = models.CharField(db_column='Relationship Manager', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")   
    f27 = models.CharField(db_column='F27', max_length=255, blank=True, null=True, db_collation="utf8mb4_general_ci")  
...
class Menumst(models.Model):
    ...
    menuname = models.CharField(db_column='MenuName', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    menupagepath = models.CharField(db_column='MenuPagePath', max_length=100, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    ...
    menuicon = models.CharField(db_column='MenuIcon', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    status = models.IntegerField(db_column='Status', blank=True, null=True)  
...
class TblError(models.Model):
    ...
    e_proc = models.CharField(db_column='E_PROC', max_length=128, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    e_line = models.IntegerField(db_column='E_LINE', blank=True, null=True)  
    e_msg = models.CharField(db_column='E_MSG', max_length=4000, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    dt = models.DateTimeField(db_column='Dt', blank=True, null=True)  
...
class Usermst(models.Model):
    id = models.AutoField(db_column='Id', primary_key=True)  
    userid = models.CharField(db_column='UserId', max_length=15, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    username = models.CharField(db_column='UserName', max_length=100, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    userrole = models.CharField(db_column='UserRole', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    userpsw = models.CharField(db_column='UserPsw', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    usersts = models.IntegerField(db_column='UserSts', blank=True, null=True)  
    cuser = models.CharField(db_column='CUser', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    cdate = models.DateTimeField(auto_now_add=True, db_column='Cdate', blank=True, null=True)
...
class Userrole(models.Model):
    rid = models.CharField(db_column='Rid', max_length=5, blank=True, null=True, db_collation="utf8mb4_general_ci")  
    role = models.CharField(db_column='Role', max_length=50, blank=True, null=True, db_collation="utf8mb4_general_ci")  
